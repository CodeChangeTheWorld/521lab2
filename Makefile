...
#
KERNEL_OBJS = kernel_start.o load_program.o mem_management.o page_table_management.o process_control_block.o process_schedule.o terminal.o context_switch.o idle.o init.o trap_handlers.o 
KERNEL_SRCS = kernel_start.c load_program.c mem_management.c page_table_management.c process_control_block.c process_schedule.c terminal.c context_switch.c idle.c init.c trap_handlers.c
